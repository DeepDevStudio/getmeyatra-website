        ...
        <BookingCard>
          <form onSubmit={handleSubmit}>
            <TripSwitcher>
              ...
              <Link to="/round-trip" className="active">
                🔄 Round Trip
              </Link>
            </TripSwitcher>
            ...
            <FormIntro>
              ...
              <div>
                <h2>Round Trip Taxi/Cab Service From</h2>
            ...
            <FormSection>
              <SectionHeading>
                ...
                <div>
                  ...
                  <p>Choose your pickup point and destination</p>
                </div>
              </SectionHeading>
            ...
            <FormSection>
              <SectionHeading>
                ...
                <div>
                  <h3>Round Trip Schedule</h3>
                  <p>Select your departure and return timings</p>
                </div>
              </SectionHeading>
